...
import { ServiceStatus, Unit } from '@prisma/client';
...
export type GetServicesForProviderResType = z.infer<
  typeof GetServicesForProviderResSchema
>;
...
export type GetServicesForProviderQueryType = z.infer<
  typeof GetServicesForProviderQuerySchema
>;
