...
export const RegisterBodySchema = RegisterBody.superRefine(
  ...
  .superRefine(({ totpCode, code }, ctx) => {
    if (totpCode !== undefined && code !== undefined) {
      ctx.addIssue({
        path: ['totpCode'],
        message:
          'You must provide either a 2FA authentication code or an OTP code. Do not provide both.',
        code: 'custom',
      });
      ctx.addIssue({
        path: ['code'],
...
export type RegisterProviderBodyType = z.infer<
  typeof RegisterProviderBodySchema
>;
