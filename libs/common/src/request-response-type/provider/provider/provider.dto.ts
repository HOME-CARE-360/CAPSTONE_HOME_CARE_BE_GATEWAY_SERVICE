...
import { CreateBookingReportBodySchema, GetBookingReportBodySchema, UpdateBookingReportBodySchema, updateUserAndServiceProviderProfileSchema } from './provider.model';
...
export class GetBookingReportsQueryDTO extends createZodDto(GetBookingReportsQuerySchema) { }
export class GetBookingReportQueryDTO extends createZodDto(GetBookingReportBodySchema) { }
