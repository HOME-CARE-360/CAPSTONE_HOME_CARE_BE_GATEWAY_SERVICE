...
import { ServiceItemSchema } from 'libs/common/src/models/shared-service-item.model';
import { z } from 'zod';
...
export const GetServiceItemsQuerySchema = z.object({
  ...
  sortBy: z
    .enum([SortByServiceItem.CreatedAt, SortByServiceItem.Price])
    .default(SortByServiceItem.CreatedAt),
});
export const GetServiceItemParamsSchema = z
  ...
  .strict();
export type GetServiceItemParamsType = z.infer<
  typeof GetServiceItemParamsSchema
>;

export type GetServiceItemsQueryType = z.infer<
  typeof GetServiceItemsQuerySchema
>;
