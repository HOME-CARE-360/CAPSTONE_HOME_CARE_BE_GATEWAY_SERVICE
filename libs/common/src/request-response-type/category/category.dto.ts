...
export class GetListCategoryQueryDTO extends createZodDto(
  GetListCategoryQuerySchema,
) {}
export class GetListCategoryResDTO extends createZodDto(
  GetListCategoryResSchema,
) {}
export class UpdateCategoryBodyDTO extends createZodDto(
  UpdateCategoryBodySchema,
) {}
export class UpdateCategoryQueryDTO extends createZodDto(
  UpdateCategoryQuerySchema,
) {}
