...
export const GetServicesRequestQuerySchema = z.object({
  ...
  sortBy: z
    .enum([SortByServiceRequest.CreatedAt, SortByServiceRequest.PreferredDate])
    .default(SortByServiceRequest.CreatedAt),
});
...
>;
export type GetServicesRequestQueryType = z.infer<
  typeof GetServicesRequestQuerySchema
>;
export type AssignStaffToBookingBodySchemaType = z.infer<
  typeof AssignStaffToBookingBodySchema
>;

export type CreateServiceRequestBodyType = z.infer<
