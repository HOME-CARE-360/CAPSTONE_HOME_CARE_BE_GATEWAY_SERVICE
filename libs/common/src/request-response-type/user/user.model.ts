...
export const getMyTxQuerySchema = z.object({
  ...
  limit: z.coerce
    ...
    .max(200)
    .default(10)
    .describe('Number of items per page, max is 200'),
  ...
  dateFrom: z
    ...
    .datetime()
    .optional()
    .describe('Start date for the transaction period (ISO 8601)'),
  dateTo: z
    .string()
    .datetime()
    .optional()
    .describe('End date for the transaction period (ISO 8601)'),
  sortBy: z
    .enum(['createdAt', 'updatedAt', 'amount', 'status'])
    .default('createdAt')
    .describe('Sort transactions by a specific field'),
