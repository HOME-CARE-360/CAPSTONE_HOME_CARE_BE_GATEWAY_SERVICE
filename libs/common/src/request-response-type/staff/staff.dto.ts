...
export class CreateInspectionReportDTO extends createZodDto(
  CreateInspectionReportSchema,
) {}
export class GetBookingDetailDTO extends createZodDto(GetBookingDetailSchema) {}
export class StaffGetReviewQueryDTO extends createZodDto(
  StaffGetReviewQuerySchema,
) {}
export class GetInspectionDetailDTO extends createZodDto(
  GetInspectionDetailSchema,
) {}
export class UpdateInspectionReportDTO extends createZodDto(
  UpdateInspectionReportSchema,
) {}
export class GetRecentWorkLogsDTO extends createZodDto(
  GetRecentWorkLogsSchema,
) {}
