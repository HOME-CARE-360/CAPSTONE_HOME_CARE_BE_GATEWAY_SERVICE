...
export type SortByServiceItemType =
  (typeof SortByServiceItem)[keyof typeof SortByServiceItem];
export type SortByWithDrawType =
  (typeof SortByWithDraw)[keyof typeof SortByWithDraw];
...
export type SortByServiceRequestType =
  (typeof SortByServiceRequest)[keyof typeof SortByServiceRequest];
