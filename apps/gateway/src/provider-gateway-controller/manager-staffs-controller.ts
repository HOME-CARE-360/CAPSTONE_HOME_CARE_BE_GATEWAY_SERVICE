...
import {
  CreateStaffBodyDTO,
  GetStaffsQueryDTO,
} from 'libs/common/src/request-response-type/provider/manage-staff/manage-staff.dto';
...
import { UpdateUserAndStaffForProviderDTO } from 'libs/common/src/request-response-type/staff/staff.dto';
